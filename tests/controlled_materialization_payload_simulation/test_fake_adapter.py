...
from forgeflow.governed_changes.materialization.fake_adapter import FakeGitDataAdapter, reject_real_mutation_input
from forgeflow.governed_changes.materialization.models import PayloadEligibilityPDR
from forgeflow.governed_changes.materialization.service import EphemeralPayloadLease
...
class FakeAdapterTest(unittest.TestCase):
    def payload_and_pdr(self):
        from forgeflow.governed_changes.materialization.models import MaterializedCommitPayload
